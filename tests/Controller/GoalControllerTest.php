...
class GoalControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Goal::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'goal[amount]' => 'Testing',
            'goal[veterinary]' => 'Testing',
            'goal[product]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'goal[amount]' => 'Something New',
            'goal[veterinary]' => 'Something New',
            'goal[product]' => 'Something New',
        ]);
